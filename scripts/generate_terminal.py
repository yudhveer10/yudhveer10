...
def build_dashboard_svg(profile: Profile, stats: dict[str, str]) -> str:
  ...
  <text x="54" y="144" class="mono small">{esc(profile.role)} | {esc(profile.location)} | building AI systems</text>
  <text x="54" y="198" class="mono small">No fragile stats providers. This card is generated by scripts/generate_terminal.py.</text>
  ...
  <text x="450" y="227" class="mono small">top language: {esc(top_language)}   focus: agents, automation, LLM apps</text>
</svg>
'''
